    ...
    >
        ...
        <div style={{ padding: '18px 24px 24px', overflowY: 'auto' }}>
          ...
          {isMachine && (
            ...
            <>
              <div style={{ fontSize: '12px', lineHeight: 1.6, color: 'var(--text-secondary)', marginBottom: '18px' }}>
                <strong style={{ color: 'var(--text-primary)', display: 'block', fontSize: '14px', marginBottom: '8px' }}>Defining Your Grammar</strong>
                • <strong style={{ color: 'var(--text-primary)' }}>Syntax</strong>: Write rules as <code style={codeStyle}>S -&gt; a S b | ε</code>. <br />
                • <strong style={{ color: 'var(--text-primary)' }}>Nonterminals</strong>: Must be uppercase letters (e.g., <code style={codeStyle}>S</code>, <code style={codeStyle}>A</code>, <code style={codeStyle}>EXPR</code>).<br />
              ...
              <div style={{ fontSize: '12px', lineHeight: 1.6, color: 'var(--text-secondary)', marginBottom: '18px' }}>
                • <strong style={{ color: 'var(--text-primary)' }}>FIRST & FOLLOW Sets</strong>: The system computes these sets in real-time, helping you debug parsing conflicts.<br />
                • <strong style={{ color: 'var(--text-primary)' }}>LL(1) Validation</strong>: Instantly checks if your grammar can be parsed top-down without backtracking.<br />
                • <strong style={{ color: 'var(--text-primary)' }}>Ambiguity Detection</strong>: Generates counter-example derivations if a string can be parsed in multiple distinct ways.
              </div>
              ...
              <div style={{ fontSize: '12px', lineHeight: 1.6, color: 'var(--text-secondary)', marginBottom: '18px' }}>
                • <strong style={{ color: 'var(--text-primary)' }}>Chomsky Normal Form (CNF)</strong>: Converts your grammar so all rules are either <code style={codeStyle}>A -&gt; BC</code> or <code style={codeStyle}>A -&gt; a</code>.<br />
                • <strong style={{ color: 'var(--text-primary)' }}>Left Recursion Elimination</strong>: Automatically removes direct and indirect left recursion so the grammar can be used with top-down parsers like LL(1).<br />
                • <strong style={{ color: 'var(--text-primary)' }}>Left Factoring</strong>: Extracts common prefixes from rules to resolve predictive parsing conflicts.
              </div>
            </>
          )}
            ...
            <>
              <div style={{ fontSize: '12px', lineHeight: 1.6, color: 'var(--text-secondary)', marginBottom: '18px' }}>
                <strong style={{ color: 'var(--text-primary)', display: 'block', fontSize: '14px', marginBottom: '8px' }}>Parsing Setup</strong>
                • <strong style={{ color: 'var(--text-primary)' }}>Grammar</strong>: Define your Context-Free Grammar in the left editor.<br />
                • <strong style={{ color: 'var(--text-primary)' }}>Input String</strong>: Enter the string you want to parse in the buffer at the top of the screen. Spaces are ignored unless explicitly defined as terminals.<br />
                • <strong style={{ color: 'var(--text-primary)' }}>Algorithms</strong>: Select from a suite of top-down and bottom-up parsers: <strong style={{ color: 'var(--text-primary)' }}>LL(1)</strong>, <strong style={{ color: 'var(--text-primary)' }}>LR(0)</strong>, <strong style={{ color: 'var(--text-primary)' }}>SLR(1)</strong>, <strong style={{ color: 'var(--text-primary)' }}>LALR(1)</strong>, <strong style={{ color: 'var(--text-primary)' }}>LR(1)</strong>, <strong style={{ color: 'var(--text-primary)' }}>Earley</strong>, or <strong style={{ color: 'var(--text-primary)' }}>CYK</strong>.
              </div>
              ...
              <div style={{ fontSize: '12px', lineHeight: 1.6, color: 'var(--text-secondary)', marginBottom: '18px' }}>
                • <strong style={{ color: 'var(--text-primary)' }}>Playback Controls</strong>: Use the timeline bar at the bottom to play, pause, step forward/backward, and adjust playback speed. Keyboard shortcuts like <code style={codeStyle}>Space</code> and arrow keys work natively.<br />
                • <strong style={{ color: 'var(--text-primary)' }}>Stack Viewer</strong>: Watch the live push/pop operations of the parser's internal stack during execution.<br />
                • <strong style={{ color: 'var(--text-primary)' }}>Parse Tables</strong>: The main view displays the ACTION and GOTO tables. For CYK and Earley, it displays their respective dynamic programming charts and state sets.<br />
                • <strong style={{ color: 'var(--text-primary)' }}>Automaton (LR)</strong>: For bottom-up parsers, view the interactive Closure/GOTO state machine diagram (the LR item sets) mapping directly to the parse table.
              </div>
              ...
              <div style={{ fontSize: '12px', lineHeight: 1.6, color: 'var(--text-secondary)', marginBottom: '18px' }}>
                • <strong style={{ color: 'var(--text-primary)' }}>Syntax Tree</strong>: If the string is accepted, the resulting concrete syntax tree is animated and drawn in the bottom panel.<br />
                • <strong style={{ color: 'var(--text-primary)' }}>Derivation</strong>: View the step-by-step leftmost or rightmost derivation of the input string.<br />
                • <strong style={{ color: 'var(--text-primary)' }}>Conflicts</strong>: If your grammar is not suitable for the selected algorithm (e.g., Shift/Reduce conflicts in LR parsers), the table will highlight the conflicting cells in red.
              </div>
            </>
          )}
