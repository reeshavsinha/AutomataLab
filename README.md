...
- **🖥️ Desktop Native**: A familiar classic-desktop workspace — a top **File / Edit / View / Simulate / Convert / Help** menu bar above a compact toolbar — with a multi-tab interface, native file saving/loading (`.autolab.json`), keyboard-accessible dialogs (focus-trapped, Esc-to-close), and over-the-air auto-updates.
